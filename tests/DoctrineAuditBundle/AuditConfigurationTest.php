...
final class AuditConfigurationTest extends BaseTest
{
    ...
    public function testDefaultTableSuffix()
    {
        $configuration = $this->getAuditConfiguration();
    ...
    public function testCustomTablePrefix()
    {
        $configuration = $this->getAuditConfiguration([
            'table_prefix' => 'audit_',
        ]);
    ...
    public function testCustomTableSuffix()
    {
        $configuration = $this->getAuditConfiguration([
    ...
    public function testGloballyIgnoredColumns()
    {
        $ignored = [
            'created_at',
            'updated_at',
    ...
    public function testGetRequestStack()
    {
        $configuration = $this->getAuditConfiguration();
    ...
    public function testIsAuditable()
    {
        $entities = [
            Post::class => [
                'enabled' => false,
     ...
     */
    public function testIsAuditedHonorsEnabledFlag()
    {
        $entities = [
            Post::class => [
                'enabled' => true,
     ...
     * @depends testIsAudited
     */
    public function testIsAuditedWhenAuditIsEnabled()
    {
        $entities = [
            Post::class => [
                'enabled' => true,
     ...
     * @depends testIsAudited
     */
    public function testIsAuditedWhenAuditIsDisabled()
    {
        $entities = [
            Post::class => [
                'enabled' => true,
     ...
     * @depends testIsAudited
     */
    public function testIsAuditedFieldAuditsAnyFieldByDefault()
    {
        $entities = [
            Post::class => null,
        ];
     ...
     */
    public function testIsAuditedFieldHonorsLocallyIgnoredColumns()
    {
        $entities = [
            Post::class => [
                'ignored_columns' => [
     ...
     */
    public function testIsAuditedFieldHonorsGloballyIgnoredColumns()
    {
        $entities = [
            Post::class => null,
        ];
     ...
     * @depends testIsAuditedFieldHonorsLocallyIgnoredColumns
     */
    public function testIsAuditedFieldReturnsFalseIfEntityIsNotAudited()
    {
        $entities = [
            Post::class => null,
        ];
     ...
     */
    public function testEnableAuditFor()
    {
        $entities = [
            Post::class => [
                'enabled' => false,
     ...
     * @depends testIsAuditedHonorsEnabledFlag
     */
    public function testDisableAuditFor()
    {
        $entities = [
            Post::class => [
                'enabled' => true,
