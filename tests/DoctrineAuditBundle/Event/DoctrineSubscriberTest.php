...
{
    public function testCustomStorageEntityManager()
    {
    ...
    public function testInsertWithoutRelation()
    {
     ...
     */
    public function testUpdateWithoutRelation()
    {
        $em = $this->getEntityManager();
     ...
     * @depends testInsertWithoutRelation
     */
    public function testRemoveWithoutRelation()
    {
        $em = $this->getEntityManager();
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingIntValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingDecimalValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingBooleanValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingPhpArrayValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingJsonArrayValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testAuditingSimpleArrayValues()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testInsertWithoutRelation
     */
    public function testOneToManyAssociate()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     */
    public function testOneToManyDissociate()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testOneToManyAssociate
     */
    public function testManyToManyAssociate()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     */
    public function testManyToManyDissociate()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
    ...
    public function testSoftRemove()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
    ...
    public function testTransactionHash()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
