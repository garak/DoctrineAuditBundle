...
final class AuditHelperTest extends CoreTest
{
    ...
    public function testDiffInsert()
    {
        $em = $this->getEntityManager();
        $configuration = $this->getAuditConfiguration();
        $helper = new AuditHelper($configuration);
    ...
    public function testDiffHonorsGloballyIgnoredColumns()
    {
        $em = $this->getEntityManager();
        $configuration = $this->getAuditConfiguration();
    ...
    public function testDiffHonorsLocallyIgnoredColumns()
    {
        $em = $this->getEntityManager();
        $configuration = $this->getAuditConfiguration();
        $configuration = new AuditConfiguration(
    ...
    public function testDiffIgnoresUnchangedValues()
    {
        $em = $this->getEntityManager();
        $configuration = $this->getAuditConfiguration();
        $helper = new AuditHelper($configuration);
    ...
    public function testBlameWhenNoRequest()
    {
        $em = $this->getEntityManager();
        $configuration = new AuditConfiguration(
            [
    ...
    public function testBlameWhenNoUser()
    {
        $em = $this->getEntityManager();
        $configuration = new AuditConfiguration(
            [
    ...
    public function testParamToNamespace()
    {
    ...
    public function testNamespaceToParam()
    {
