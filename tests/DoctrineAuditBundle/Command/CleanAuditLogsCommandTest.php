...
final class CleanAuditLogsCommandTest extends CoreTest
{
    ...
    public function testExecuteFailsWithKeepNegative()
    {
        ...
        self::assertContains("'keep' argument must be a positive number.", $output);
    }

    /**
     * @depends testExecuteFailsWithKeepNegative
     */
    public function testExecuteFailsWithKeepNull()
    {
        $command = $this->createCommand();
        $commandTester = new CommandTester($command);
        $commandTester->execute([
    ...
    public function testExecute()
    {
        ...
        // the output of the command in the console
        $output = $commandTester->getDisplay();
        self::assertContains('[OK] Success', $output);
    }

    /**
     * @depends testExecute
     */
    public function testExecuteFailsWhileLocked()
    {
        ...
        // the output of the command in the console
        $output = $commandTester->getDisplay();
        self::assertContains('The command is already running in another process.', $output);
    }
