...
{
    public function testGetAuditConfiguration()
    {
    ...
    public function testFilterIsEmptyByDefault()
    {
        $reader = $this->getReader();
    ...
    public function testFilterIsEmptyIfNotPartOfAllowedValues()
    {
        $reader = $this->getReader();
    ...
    public function testGetEntityTableName()
    {
        $entities = [
            Post::class => null,
            Comment::class => null,
    ...
    public function testGetEntityTableAuditName()
    {
        $entities = [
            Post::class => null,
            Comment::class => null,
    ...
    public function testGetAuditsPager()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
        ...
        self::assertInternalType('array', $pager);
        self::assertTrue($pager['haveToPaginate'], 'pager has to paginate.');
    }

    public function testGetAuditsCount()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     */
    public function testGetAuditsHonorsId()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testGetAudits
     */
    public function testGetAuditsHonorsPageSize()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testGetAudits
     */
    public function testGetAuditsHonorsFilter()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
     ...
     * @depends testGetAudits
     */
    public function testGetAuditHonorsFilter()
    {
        $reader = $this->getReader($this->getAuditConfiguration());
    ...
    public function testGetAuditByTransactionHash()
    {
    ...
    public function testGetAllAuditsByTransactionHash()
    {
        $em = $this->getEntityManager();
        $reader = $this->getReader($this->getAuditConfiguration());
