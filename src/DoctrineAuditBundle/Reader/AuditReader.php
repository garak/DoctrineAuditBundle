...
class AuditReader
{
    ...
    private function filterByTransaction(QueryBuilder $queryBuilder, string $transactionHash = null): QueryBuilder
    {
     ...
     * @throws InvalidArgumentException
     */
    private function checkAuditable(string $entity)
    {
        if (!$this->configuration->isAuditable($entity)) {
     ...
     * @throws AccessDeniedException
     */
    private function checkRoles(string $entity, string $scope)
    {
