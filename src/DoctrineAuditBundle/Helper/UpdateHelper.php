...
class UpdateHelper
{
     ...
     */
    public function updateAuditSchema(array $sqls = null, callable $callback = null)
    {
     ...
     */
    private function processColumns(Table $table, array $columns, array $expectedColumns)
    {
        $processed = [];
     ...
     * @throws \Doctrine\DBAL\Schema\SchemaException
     */
    private function processIndices(Table $table, array $expectedIndices)
    {
