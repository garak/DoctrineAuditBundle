...
class AuditManager
{
     ...
     */
    public function process(AuditTransaction $transaction)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function insert(EntityManagerInterface $em, $entity, array $ch, string $transactionHash)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function update(EntityManagerInterface $em, $entity, array $ch, string $transactionHash)
    {
        $diff = $this->helper->diff($em, $entity, $ch);
        if (0 === \count($diff)) {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function remove(EntityManagerInterface $em, $entity, $id, string $transactionHash)
    {
        /** @var ClassMetadata $meta */
        $meta = $em->getClassMetadata(\get_class($entity));
        $this->audit([
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function associate(EntityManagerInterface $em, $source, $target, array $mapping, string $transactionHash)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function dissociate(EntityManagerInterface $em, $source, $target, array $mapping, string $transactionHash)
    {
     ...
     */
    public function setHelper(AuditHelper $helper)
    {
        $this->helper = $helper;
    }
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function processInsertions(AuditTransaction $transaction)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function processUpdates(AuditTransaction $transaction)
    {
        $em = $transaction->getEntityManager();
        $uow = $em->getUnitOfWork();
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function processAssociations(AuditTransaction $transaction)
    {
        $em = $transaction->getEntityManager();
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function processDissociations(AuditTransaction $transaction)
    {
        $em = $transaction->getEntityManager();
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function processDeletions(AuditTransaction $transaction)
    {
        $em = $transaction->getEntityManager();
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    private function associateOrDissociate(string $type, EntityManagerInterface $em, $source, $target, array $mapping, string $transactionHash)
    {
        /** @var ClassMetadata $meta */
     ...
     * @throws Exception
     */
    private function audit(array $data)
    {
