...
class AuditTransaction
{
     ...
     */
    public function collectScheduledInsertions(UnitOfWork $uow)
    {
     ...
     * @param UnitOfWork $uow
     */
    public function collectScheduledUpdates(UnitOfWork $uow)
    {
     ...
     */
    public function collectScheduledDeletions(UnitOfWork $uow, EntityManagerInterface $em)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function collectScheduledCollectionUpdates(UnitOfWork $uow, EntityManagerInterface $em)
    {
     ...
     * @throws \Doctrine\ORM\Mapping\MappingException
     */
    public function collectScheduledCollectionDeletions(UnitOfWork $uow, EntityManagerInterface $em)
    {
